                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                    ...
                                    <select name="id_pengajuan" id="id_pengajuan" class="form-control select2" style="width:100%;" onchange="viewDetailPengajuan()">
                                        ...
                                        <?php
                                            if($pengajuan)
                                            {
                                                ...
                                                {
                                                    $selected = ($row_pengajuan->id_pengajuan == (set_value('id_pengajuan') ? set_value('id_pengajuan') : $ubah->id_pengajuan) ? 'selected' : '');
                                                    echo '<option value="'.$row_pengajuan->id_pengajuan.'" '.$selected.'>'.$row_pengajuan->nama_mahasiswa.'</option>';
                                                }
                                            }
                                            echo '<option value="'.$ubah->id_pengajuan.'" selected>'.$ubah->nama_mahasiswa.'</option>';
                                        ?>
                                    </select>       
                                ...
                                <div class="col-md-9">
                                    <select name="id_ruangan" id="id_ruangan" class="form-control select2" style="width:100%;">
                                        ...
                                        if($ruangan)
                                        {
                                            ...
                                            {
                                                $selected = ((set_value('id_ruangan') ? set_value('id_ruangan') : $ubah->id_ruangan) == $row_ruangan->id_ruangan ? 'selected' : '');
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input onkeydown="event.preventDefault()" type="text" class="form-control" name="jadwal_sidang" id="jadwal_sidang" value="<?php echo (set_value('jadwal_sidang') ? set_value('jadwal_sidang') : ($ubah->jadwal_sidang && $ubah->jadwal_sidang != '0000-00-00' ? date('d/m/Y', strtotime($ubah->jadwal_sidang)) : ''));?>">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input onkeydown="event.preventDefault()" type="text" class="form-control" name="jam_sidang" id="jam_sidang" value="<?php echo (set_value('jam_sidang') ? set_value('jam_sidang') : $ubah->jam_sidang);?>">
