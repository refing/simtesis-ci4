...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?= base_url('dashboard') ?>">SIM TESIS</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="sb-sidenav-menu-heading">Core</div>
                            ...
                            <div class="collapse" id="collapseDaftar" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url('pendaftaran/sempro') ?>">Pendaftaran Seminar Proposal</a>
                                    <a class="nav-link" href="<?= base_url('pendaftaran/sidang') ?>">Pendaftaran Sidang Tesis</a>
                                    <a class="nav-link" href="<?= base_url('pendaftaran/yudisium') ?>">Pendaftaran Yudisium</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseData" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url('datadiri') ?>">Data Diri Seminar Proposal</a>
                                    <a class="nav-link" href="<?= base_url('datadiri') ?>">Data Diri Sidang Tesis</a>
                                    <a class="nav-link" href="<?= base_url('datadiri') ?>">Data Diri Yudisium</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseJadwal" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url('jadwal/sempro') ?>">Jadwal Seminar Proposal</a>
                                    <a class="nav-link" href="<?= base_url('jadwal/sidang') ?>">Jadwal Sidang Tesis</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseBerkas" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url('berkas/sempro') ?>">Berkas Seminar Proposal</a>
                                    <a class="nav-link" href="<?= base_url('berkas/sidang') ?>">Berkas Sidang Tesis</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseNilai" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url('nilai/sempro') ?>">Nilai & Status Seminar Proposal</a>
                                    <a class="nav-link" href="<?= base_url('nilai/sidang') ?>">Nilai & Status Sidang Tesis</a>
                                    <a class="nav-link" href="<?= base_url('nilai/yudisium') ?>">Nilai & Status Yudisium</a>
                                </nav>
                            </div>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Pendaftaran Yudisium</li>
                        </ol>
                        <div class="row">
