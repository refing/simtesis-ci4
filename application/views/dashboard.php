                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseNilai" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= site_url('nilai/sempro') ?>">Nilai & Status Seminar Proposal</a>
                                    <a class="nav-link" href="<?= site_url('nilai/sidang') ?>">Nilai & Status Sidang Tesis</a>
                                    <a class="nav-link" href="<?= site_url('nilai/yudisium') ?>">Nilai & Status Yudisium</a>
                                </nav>
                            </div>
