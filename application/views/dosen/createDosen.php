                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" name="nip_dosen" id="nip_dosen" value="<?php echo set_value('nip_dosen');?>">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" name="nama_dosen" id="nama_dosen" value="<?php echo set_value('nama_dosen');?>">
