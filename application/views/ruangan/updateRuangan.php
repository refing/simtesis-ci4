                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" name="kode_ruangan" id="kode_ruangan" value="<?php echo (set_value('kode_ruangan') ? set_value('kode_ruangan') : $ubah->kode_ruangan);?>">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" name="nama_ruangan" id="nama_ruangan" value="<?php echo (set_value('nama_ruangan') ? set_value('nama_ruangan') : $ubah->nama_ruangan);?>">
