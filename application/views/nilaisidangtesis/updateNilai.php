                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control allownumericwithdecimal" type="text" autocomplete="off" name="nilai" id="nilai" value="<?php echo (set_value('nilai') ? set_value('nilai') : $ubah->nilai);?>">
                                ...
                                <div class="col-md-9">
                                    <div>                                        
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="status_finalthesis" id="status_finalthesis_y" value="LULUS" <?php echo ($ubah->status_finalthesis == 'LULUS' ? 'checked' : '');?>>
                                          <label class="form-check-label" for="status_finalthesis_y">LULUS</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="status_finalthesis" id="status_finalthesis_n" value="TIDAK LULUS" <?php echo ($ubah->status_finalthesis == 'TIDAK LULUS' ? 'checked' : '');?>>
